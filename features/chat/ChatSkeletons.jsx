...
// Every loading placeholder in the chat module. Each takes a `count` so callers
// render <XSkeleton count={8} /> instead of repeating an Array.from map.
...
// Mixed bubble sizes so the placeholder reads as a conversation, not a list.
