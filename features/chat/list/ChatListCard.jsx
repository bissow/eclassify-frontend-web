...
import { getIsRtl, CurrentLanguageData } from "@/store/slices/languageSlice";
...
const ChatListCard = ({
  ...
  const { country_code, code } = useSelector(CurrentLanguageData);
  const locale = country_code ? `${code}-${country_code}` : code ?? "en";
        ...
        <div className="py-3 px-4 flex items-center gap-4">
          ...
          <div className="flex flex-col gap-2 w-full min-w-0">
            ...
            <div className="w-full flex gap-1 items-center justify-between min-w-0">
              ...
              >
                {timeAgo(chat?.last_message_time, locale)}
              </span>
            </div>
