...
import { formatPriceAbbreviated, formatTime } from "@/lib/format";
...
import EmptyMessage from "@/components/empty-states/EmptyMessage";
...
// Owns its list entirely — mounted only while the selling tab is open, so the
// search term resets on tab change without an effect.
const AdList = () => {
...
const AdCard = ({ chat }) => {
  ...
  const time = formatTime(chat.last_offer_updated, t);
