...
const Search = () => {
  ...
  const handleSearchNav = (e) => {
    ...
    if (stayOnCurrentPage) {
      ...
      // Real navigation, not history.pushState: /ads renders its listing on the
      // server from the query string, so the server has to re-run for a new
      // search term to take effect.
      navigate(
