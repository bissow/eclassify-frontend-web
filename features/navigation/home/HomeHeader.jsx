...
import MailSentSuccessModal from "@/features/auth/MailSentSuccessModal.jsx";
...
import DeleteAccountVerifyOtpModal from "@/features/auth/DeleteAccountVerifyOtpModal.jsx";
import PackageRequiredModal from "@/components/common/PackageRequiredModal";
import SelectAdTypeModal from "@/features/navigation/home/SelectAdTypeModal.jsx";
import Search from "@/features/navigation/home/Search.jsx";
import { useTranslation } from "@/lang/useTranslation";
import { Skeleton } from "@/components/ui/skeleton";

const AuthActions = dynamic(
  () => import("@/features/navigation/home/AuthActions.jsx"),
  { ssr: false, loading: () => <Skeleton className="w-32 h-8" /> }
);

const LoginModal = dynamic(() => import("@/features/auth/login/LoginModal.jsx"), {
  ssr: false,
});
const RegisterModal = dynamic(
  () => import("@/features/auth/register/RegisterModal.jsx"),
  {
    ssr: false,
  }
);
const LocationModal = dynamic(
  () => import("@/features/location/LocationModal.jsx"),
  {
    ssr: false,
  }
);
